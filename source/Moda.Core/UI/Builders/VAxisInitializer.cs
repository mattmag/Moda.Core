...
public interface IVAxisInitializer
{
    VAdjacencyBuilder AbovePrevious();
    VAdjacencyBuilder BelowPrevious();
    
    public VAnchorBuilder AnchorUp();
    public VAnchorBuilder AnchorMiddle();
    public VAnchorBuilder AnchorDown();
}



public class VAxisInitializer : IVAxisInitializer
{
    private readonly CellBuilderState runningState;


    public VAxisInitializer(CellBuilderState runningState)
    {
