...
public class PercentOfParent : Length
{
    ...
    {
        return (from parent in this.Owner.Parent
    ...
    private IEnumerable<Coordinate> GetAxisCoordinates(Option<Cell> cell) =>
        (from c in cell select c.GetBoundary(this.Axis).GetCoordinates())
